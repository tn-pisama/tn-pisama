...
On the [TRAIL benchmark](https://arxiv.org/abs/2505.08638) (148 multi-agent traces, 841 annotated errors): 43.9% joint accuracy. Built on the [MAST taxonomy](https://arxiv.org/abs/2503.13657) (NeurIPS 2025).
...
[![pisama-claude-code](https://img.shields.io/pypi/v/pisama-claude-code?label=pisama-claude-code&style=flat-square&color=blue)](https://pypi.org/project/pisama-claude-code/)
